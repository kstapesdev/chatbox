...
public class ChatMessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSendButton = view.findViewById(R.id.chatMessageText);
        mImageView = view.findViewById(R.id.chatSendImage);


        ((View) mImageView).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String chatMessage = mSendButton.getText().toString();

                msg.chatSender = chatSender;
                msg.chatText = chatMessage;
                msg.chatSendTime = chatSendTime;

                String nodeKey = chatSendTime + " " + chatSender;
